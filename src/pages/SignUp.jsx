...
const SignUp = () => {
  return (
    ...
    <div className="w-full text-center bg-orange-200 py-10 ">
      <p className="text-sm text-gray-500">Home / <span className="text-gray-900">Sign Up</span></p>
    ...
    <div className="bg-white border rounded-md shadow-sm mt-10 w-full max-w-md p-8">
      ...
      <form className="space-y-4">
        ...
        <button type="submit" className="w-full border border-black py-2 text-black font-semibold">
          Sign Up
        </button>
      </form>
    </div>
