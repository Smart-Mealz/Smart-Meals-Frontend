  ...
  return (
    <>
      ...
      <section className="bg-white py-2 px-4 text-center">
        <div className="grid grid-cols-2 sm:grid-rows-3 md:grid-cols-5 gap-4">
          {[...Array(10)].map((_, i) => (
            <div className="text-center" key={i}>
              <img src={salad} alt="Salad" className="w-full h-auto object-cover rounded" />
              <h2 className="text-orange-400 text-xl">Salads</h2>
              <p>Greek olive salad</p>
            </div>
          ))}
        </div>
        <div className="mt-4">
        ...
        <div className="relative w-full h-[400px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white shadow-lg p-8 rounded-md text-center max-w-md w-full">
              <h2 className="text-2xl font-bold text-blue-800">Get started now</h2>
              <p className="text-gray-600 mt-2">
                for as little as <span className="text-blue-600 font-semibold">GHC 25 per meal kit</span>
              </p>
              <button className="mt-4 bg-blue-800 text-white px-6 py-2 rounded-full font-semibold">
                SEE MEAL KIT
              </button>
            </div>
          </div>
