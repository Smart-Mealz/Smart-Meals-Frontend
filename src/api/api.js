...
const api = axios.create({
  baseURL: 'https://smart-meals-backend.onrender.com/api/v1', // Your API base URL
...
// Function to fetch meal kits with pagination support
export const fetchMealkits = async (page = 1) => {
  try {
    const response = await api.get(`/admin/mealkits?page=${page}`); // Pass the page number in the query
